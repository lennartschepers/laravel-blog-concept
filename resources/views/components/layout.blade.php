...
<title>Laravel blog concept</title>
...
<body style="font-family: Open Sans, sans-serif">
  <section class="px-6 py-8">
    <nav class="md:flex md:justify-between md:items-center">
      <div>
        <a href="/">
          <img src="/images/logo.svg" alt="laravel logo" width="165" height="16">
        </a>
      </div>

      <div class="mt-8 md:mt-0 flex items-center">
        {{-- make this link only visible if you are logged in --}}
        @auth
        <x-dropdown>
          <x-slot name="trigger">
    ...
    <footer id="newsletter" class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
      <img src="/images/mailbox-icon.svg" alt="" class="mx-auto -mb-6" style="width: 145px;">
      <h5 class="text-3xl">Stay in touch with the latest posts</h5>
      <p class="text-sm mt-3">We will notify you when new posts come in.</p>
  ...
  {{-- flash message component with alpinejs --}}
  <x-flash />
</body>
